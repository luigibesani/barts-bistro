  ...
  render() {
    return (
      <div className="grid grid-cols-7">
        <div className="grid grid-cols-4 bg-stone-200 col-span-7 xs:col-span-7 sm:col-span-7 md:col-span-3 z-20">
          <div></div>
          <div className="col-span-2 ">
            <div className="text-5xl text-green-800 font-semibold grid justify-center text-center self-center pt-10">
              The dough
              <hr className="my-12 h-0.5 border-t-0 bg-green-800 opacity-50 dark:opacity-50 w-5/6 mx-auto" />
            </div>
            <div className="grid justify-center self-center text-center text-2xl ">
              ...
              24h, always. We recreate that airy look time and time again.{" "}
            </div>
        ...
        <div
          className="col-span-4 bg-repeat hidden sm:hidden md:block z-20"
          style={{
            backgroundImage: `url(
